...
#define ADC_DEFAULT_VREF_SEL               (7u)
...
#define ADC_DEFAULT_VREF_MV_VALUE          (3214)
...
#define ADC_DEFAULT_BCLKS_NUM              (10u)
#define ADC_DEFAULT_CCLKS_NUM              (2u)
#define ADC_DEFAULT_DCLKS_NUM              (2u)
#define ADC_TOTAL_CHANNELS_NUM             (9u)
#define ADC_SEQUENCED_CHANNELS_NUM         (9u)
#define ADC_DEFAULT_EN_CHANNELS            (511u)
#define ADC_NOMINAL_CLOCK_FREQ             (1200000)
