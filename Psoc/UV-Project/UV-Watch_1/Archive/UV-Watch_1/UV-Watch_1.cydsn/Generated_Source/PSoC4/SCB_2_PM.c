...
****************************************************************************//**
*
*  Prepares the SCB_2 component to enter Deep Sleep.
...
*    disabling.
*
*  Call the SCB_2_Sleep() function before calling the 
...
****************************************************************************//**
*
*  Prepares the SCB_2 component for Active mode operation after 
*  Deep Sleep.
...
*
*  \sideeffect
*   Calling the SCB_2_Wakeup() function without first calling the 
*   SCB_2_Sleep() function may produce unexpected behavior.
*
*******************************************************************************/
