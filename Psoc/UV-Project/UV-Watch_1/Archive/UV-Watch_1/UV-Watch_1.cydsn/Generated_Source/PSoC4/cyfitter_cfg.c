...
static void ClockSetup(void)
{
	...
	CY_SET_REG32((void *)(CYREG_BLE_BLERD_BB_XO_CAPTRIM), 0x00007171u);
	...
	CY_SET_REG32((void *)CYREG_PERI_DIV_16_CTL3, 0x0005DB00u);
	CY_SET_REG32((void *)CYREG_PERI_DIV_CMD, 0x8000FF43u);
	CY_SET_REG32((void *)CYREG_PERI_DIV_16_CTL0, 0x00000A00u);
	...
	CY_SET_REG32((void *)(CYREG_PERI_PCLK_CTL7), 0x00000043u);

	/* CYDEV_PERI_PCLK_CTL6 Starting address: CYDEV_PERI_PCLK_CTL6 */
	CY_SET_REG32((void *)(CYREG_PERI_PCLK_CTL6), 0x00000040u);

	/* CYDEV_PERI_PCLK_CTL2 Starting address: CYDEV_PERI_PCLK_CTL2 */
	CY_SET_REG32((void *)(CYREG_PERI_PCLK_CTL2), 0x00000041u);
...
static void AnalogSetDefault(void)
{
	...
	CY_SET_XTND_REG32((void CYFAR *)CYREG_SAR_MUX_SWITCH0, 0x00000080u);
...
void cyfitter_cfg(void)
{
...

	{
		...
		CY_SET_REG32((void *)(CYDEV_HSIOM_BASE), 0xEE990000u);
	...
	CY_SET_REG32((void *)(CYDEV_GPIO_PRT1_BASE), 0x000000F0u);
	CY_SET_REG32((void *)(CYREG_GPIO_PRT1_PC), 0x00492000u);

	/* IOPINS0_3 Starting address: CYDEV_GPIO_PRT3_BASE */
	CY_SET_REG32((void *)(CYDEV_GPIO_PRT3_BASE), 0x000000F0u);
	CY_SET_REG32((void *)(CYREG_GPIO_PRT3_PC), 0x000A4000u);
	CY_SET_REG32((void *)(CYREG_GPIO_PRT3_PC2), 0x00000080u);
