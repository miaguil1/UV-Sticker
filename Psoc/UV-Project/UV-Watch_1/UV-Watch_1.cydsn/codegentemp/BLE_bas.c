...
const CYBLE_BASS_T cyBle_bass[0x01u] = {
    {
        0x003Bu, /* Handle of the BAS service */ 
        0x003Du, /* Handle of the Battery Level characteristic */ 
        0x003Eu, /* Handle of the Characteristic Presentation Format descriptor */ 
        0x003Fu, /* Handle of the Client Characteristic Configuration descriptor */ 
    },
};
