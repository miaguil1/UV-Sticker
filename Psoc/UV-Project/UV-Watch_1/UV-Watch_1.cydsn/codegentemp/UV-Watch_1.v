// ======================================================================
// UV-Watch_1.v generated from TopDesign.cysch
// 04/07/2018 at 03:56
...
module top ;
    ...
    ADC_SAR_SEQ_P4_v2_50_0 ADC_SAR_Seq_1 (
        .Vref(Net_267),
        .sdone(Net_268),
        .eoc(Net_269),
        .aclk(1'b0),
	...
	wire [0:0] tmpOE__LED_BLE_net;
	wire [0:0] tmpFB_0__LED_BLE_net;
	wire [0:0] tmpIO_0__LED_BLE_net;
	wire [0:0] tmpINTERRUPT_0__LED_BLE_net;
	electrical [0:0] tmpSIOVREF__LED_BLE_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("3899b5dc-effb-43d8-8853-66d82e684bc9"),
		  ...
		  .input_buffer_sel(2'b00))
		LED_BLE
		 (.oe(tmpOE__LED_BLE_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LED_BLE_net[0:0]}),
		  .io({tmpIO_0__LED_BLE_net[0:0]}),
		  .siovref(tmpSIOVREF__LED_BLE_net),
		  .interrupt({tmpINTERRUPT_0__LED_BLE_net[0:0]}),
		  .annotation({Net_309}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__LED_BLE_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
