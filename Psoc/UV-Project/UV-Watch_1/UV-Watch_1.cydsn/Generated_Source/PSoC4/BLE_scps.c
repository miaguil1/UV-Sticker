...
{
    0x0035u,    /* Handle of the SCPS service */
    0x0037u,    /* Handle of the Scan Interval Window  characteristic */
    0x0039u,    /* Handle of the Scan Refresh characteristic */
    0x003Au,    /* Handle of the Client Characteristic Configuration descriptor */
};
