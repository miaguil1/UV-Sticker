...
#define SPI_SPI_INTR_RX_MASK           (0x0u)
#define SPI_SPI_INTR_TX_MASK           (0x0u)
...
#define SPI_UART_MP_RX_ADDRESS         (0x2u)
#define SPI_UART_MP_RX_ADDRESS_MASK    (0xFFu)

#define SPI_UART_INTERRUPT_MODE        (0u)

#define SPI_UART_INTR_RX_MASK          (0x0u)
#define SPI_UART_INTR_TX_MASK          (0x0u)
...
#define SPI_UART_RX_BREAK_WIDTH        (11u)
...
/* UART specific functions */
    ...
    /* UART TX direction APIs */
        ...
        *******************************************************************************/
        ...
        void SPI_UartSendBreakBlocking(uint32 breakWidth);
...
***************************************/
    ...
    #define SPI_UART_DEFAULT_UART_RX_CTRL \
                    (SPI_GET_UART_RX_CTRL_MODE(SPI_UART_STOP_BITS_NUM)                    | \
                     ...
                     SPI_GET_UART_RX_CTRL_BREAK_WIDTH(SPI_UART_RX_BREAK_WIDTH)            | \
