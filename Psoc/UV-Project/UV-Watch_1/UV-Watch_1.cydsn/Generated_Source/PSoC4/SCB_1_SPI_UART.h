...
#define SCB_1_SPI_INTR_RX_MASK           (0x0u)
#define SCB_1_SPI_INTR_TX_MASK           (0x0u)
...
#define SCB_1_UART_MP_RX_ADDRESS         (0x2u)
#define SCB_1_UART_MP_RX_ADDRESS_MASK    (0xFFu)

#define SCB_1_UART_INTERRUPT_MODE        (0u)

#define SCB_1_UART_INTR_RX_MASK          (0x0u)
#define SCB_1_UART_INTR_TX_MASK          (0x0u)
...
#define SCB_1_UART_RX_BREAK_WIDTH        (11u)
...
***************************************/
    ...
    #define SCB_1_UART_DEFAULT_UART_RX_CTRL \
                    (SCB_1_GET_UART_RX_CTRL_MODE(SCB_1_UART_STOP_BITS_NUM)                    | \
                     ...
                     SCB_1_GET_UART_RX_CTRL_BREAK_WIDTH(SCB_1_UART_RX_BREAK_WIDTH)            | \
