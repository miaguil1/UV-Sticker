    ...
    *******************************************************************************/
    void SCB_2_I2CInit(const SCB_2_I2C_INIT_STRUCT *config)
    {
        ...
        else
        {
            ...
            SCB_2_INTR_MASTER_MASK_REG = SCB_2_NO_INTR_SOURCES;
...
/*******************************************************************************
* Function Name: SCB_2_I2CFwBlockReset
****************************************************************************//**
*
* Resets the scb IP block and I2C into the known state.
*
*******************************************************************************/
void SCB_2_I2CFwBlockReset(void)
{
