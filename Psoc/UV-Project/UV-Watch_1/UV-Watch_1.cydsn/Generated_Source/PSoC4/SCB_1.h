...
#define SCB_1_CY_SCBIP_V2    (CYIPBLOCK_m0s8scb_VERSION >= 2u)

/** Component version major.minor */
#define SCB_1_COMP_VERSION_MAJOR    (4)
#define SCB_1_COMP_VERSION_MINOR    (0)
    
#define SCB_1_SCB_MODE           (4u)
...
#define SCB_1_REMOVE_SCB_IRQ             (1u)
...
#define SCB_1_REMOVE_SCB_CLK     (0u)
#define SCB_1_SCB_CLK_INTERNAL   (0u == SCB_1_REMOVE_SCB_CLK)
...
/* Interface to internal interrupt component */
    ...
    *******************************************************************************/
    ...
    /*******************************************************************************
    * Function Name: SCB_1_DisableInt
    ****************************************************************************//**
    *
    ...
    *******************************************************************************/    
    ...
    /*******************************************************************************
    * Function Name: SCB_1_ClearPendingInt
    ****************************************************************************//**
    *
    ...
    *******************************************************************************/
    ...
    /*******************************************************************************
    * Function Name: SCB_1_RxWakeEnableInt
    ****************************************************************************//**
    *
    ...
    *******************************************************************************/    
    ...
    /*******************************************************************************
    * Function Name: SCB_1_RxWakeDisableInt
    ****************************************************************************//**
    *
    ...
    *******************************************************************************/
    ...
    /*******************************************************************************
    * Function Name: SCB_1_RxWakeClearPendingInt
    ****************************************************************************//**
    *
...
/* Get interrupt cause */
/*******************************************************************************
* Function Name: SCB_1_GetInterruptCause
****************************************************************************//**
*
...
*    - SCB_1_INTR_CAUSE_MASTER - Interrupt from Master
*    - SCB_1_INTR_CAUSE_SLAVE - Interrupt from Slave
*    - SCB_1_INTR_CAUSE_TX - Interrupt from TX
*    - SCB_1_INTR_CAUSE_RX - Interrupt from RX
*
*******************************************************************************/
...
/*******************************************************************************
* Function Name: SCB_1_GetRxInterruptSource
****************************************************************************//**
*
...
*   - SCB_1_INTR_RX_FIFO_LEVEL - The number of data elements in the 
      RX FIFO is greater than the value of RX FIFO level.
*   - SCB_1_INTR_RX_NOT_EMPTY - Receiver FIFO is not empty.
*   - SCB_1_INTR_RX_FULL - Receiver FIFO is full.
*   - SCB_1_INTR_RX_OVERFLOW - Attempt to write to a full 
*     receiver FIFO.
*   - SCB_1_INTR_RX_UNDERFLOW - Attempt to read from an empty 
*     receiver FIFO.
*   - SCB_1_INTR_RX_FRAME_ERROR - UART framing error detected.
*   - SCB_1_INTR_RX_PARITY_ERROR - UART parity error detected.
*
*******************************************************************************/
...
/*******************************************************************************
* Function Name: SCB_1_SetRxInterruptMode
****************************************************************************//**
*
...
*   SCB_1_GetRxInterruptSource() function for bit fields values).
*
*******************************************************************************/
...
/*******************************************************************************
* Function Name: SCB_1_GetRxInterruptMode
****************************************************************************//**
*
...
/*******************************************************************************
* Function Name: SCB_1_GetRxInterruptSourceMasked
****************************************************************************//**
*
...
/*******************************************************************************
* Function Name: SCB_1_ClearRxInterruptSource
****************************************************************************//**
*
...
*   - SCB_1_INTR_RX_FIFO_LEVEL Interrupt source is not cleared when 
*     the receiver FIFO has more entries than level.
*   - SCB_1_INTR_RX_NOT_EMPTY Interrupt source is not cleared when
*     receiver FIFO is not empty.
*   - SCB_1_INTR_RX_FULL Interrupt source is not cleared when 
...
/*******************************************************************************
* Function Name: SCB_1_SetRxInterrupt
****************************************************************************//**
*
...
*   register (refer to SCB_1_GetRxInterruptSource() function for bit 
*   fields values).
*
*******************************************************************************/
...
/*******************************************************************************
* Function Name: SCB_1_GetTxInterruptSource
****************************************************************************//**
*
...
*   Each constant is a bit field value. The value returned may have multiple 
*   bits set to indicate the current status.
*   - SCB_1_INTR_TX_FIFO_LEVEL - The number of data elements in the 
*     TX FIFO is less than the value of TX FIFO level.
*   - SCB_1_INTR_TX_NOT_FULL - Transmitter FIFO is not full.
*   - SCB_1_INTR_TX_EMPTY - Transmitter FIFO is empty.
*   - SCB_1_INTR_TX_OVERFLOW - Attempt to write to a full 
*     transmitter FIFO.
*   - SCB_1_INTR_TX_UNDERFLOW - Attempt to read from an empty 
*     transmitter FIFO.
*   - SCB_1_INTR_TX_UART_NACK - UART received a NACK in SmartCard 
*   mode.
*   - SCB_1_INTR_TX_UART_DONE - UART transfer is complete. 
*     All data elements from the TX FIFO are sent.
*   - SCB_1_INTR_TX_UART_ARB_LOST - Value on the TX line of the UART
...
/*******************************************************************************
* Function Name: SCB_1_SetTxInterruptMode
****************************************************************************//**
*
...
*   SCB_1_GetTxInterruptSource() function for bit field values).
*
*******************************************************************************/
...
/*******************************************************************************
* Function Name: SCB_1_GetTxInterruptMode
****************************************************************************//**
*
...
/*******************************************************************************
* Function Name: SCB_1_GetTxInterruptSourceMasked
****************************************************************************//**
*
...
/*******************************************************************************
* Function Name: SCB_1_ClearTxInterruptSource
****************************************************************************//**
*
...
*   - SCB_1_INTR_TX_FIFO_LEVEL - Interrupt source is not cleared when 
*     transmitter FIFO has less entries than level.
*   - SCB_1_INTR_TX_NOT_FULL - Interrupt source is not cleared when
*     transmitter FIFO has empty entries.
*   - SCB_1_INTR_TX_EMPTY - Interrupt source is not cleared when 
*     transmitter FIFO is empty.
*   - SCB_1_INTR_TX_UNDERFLOW - Interrupt source is not cleared when 
...
/*******************************************************************************
* Function Name: SCB_1_SetTxInterrupt
****************************************************************************//**
*
*  Sets RX interrupt sources in the interrupt request register.
*
...
/*******************************************************************************
* Function Name: SCB_1_GetMasterInterruptSource
****************************************************************************//**
*
...
*   Each constant is a bit field value. The value returned may have multiple 
*   bits set to indicate the current status.
*   - SCB_1_INTR_MASTER_SPI_DONE - SPI master transfer is complete.
...
/*******************************************************************************
* Function Name: SCB_1_SetMasterInterruptMode
****************************************************************************//**
*
...
*   SCB_1_GetMasterInterruptSource() function for bit field values).
*
*******************************************************************************/
#define SCB_1_SetMasterInterruptMode(interruptMask)  SCB_1_WRITE_INTR_MASTER_MASK(interruptMask)

/*******************************************************************************
* Function Name: SCB_1_GetMasterInterruptMode
****************************************************************************//**
*
...
*   SCB_1_GetMasterInterruptSource() function for return values).
*
*******************************************************************************/
#define SCB_1_GetMasterInterruptMode()   (SCB_1_INTR_MASTER_MASK_REG)

/*******************************************************************************
* Function Name: SCB_1_GetMasterInterruptSourceMasked
****************************************************************************//**
*
...
/*******************************************************************************
* Function Name: SCB_1_ClearMasterInterruptSource
****************************************************************************//**
*
...
/*******************************************************************************
* Function Name: SCB_1_SetMasterInterrupt
****************************************************************************//**
*
*  Sets Master interrupt sources in the interrupt request register.
*
*  \param interruptMask: Master interrupt sources to set in the Master interrupt
*   request register (refer to SCB_1_GetMasterInterruptSource() 
...
/*******************************************************************************
* Function Name: SCB_1_GetSlaveInterruptSource
****************************************************************************//**
*
...
*   Each constant is a bit field value. The value returned may have multiple 
*   bits set to indicate the current status.
*   - SCB_1_INTR_SLAVE_I2C_ARB_LOST - I2C slave lost arbitration: 
*     the value driven on the SDA line is not the same as the value observed 
*     on the SDA line.
*   - SCB_1_INTR_SLAVE_I2C_NACK - I2C slave received negative 
*     acknowledgement (NAK).
*   - SCB_1_INTR_SLAVE_I2C_ACK - I2C slave received 
*     acknowledgement (ACK).
*   - SCB_1_INTR_SLAVE_I2C_WRITE_STOP - Stop or Repeated Start 
*     event for write transfer intended for this slave (address matching 
*     is performed).
*   - SCB_1_INTR_SLAVE_I2C_STOP - Stop or Repeated Start event 
*     for (read or write) transfer intended for this slave (address matching 
*     is performed).
*   - SCB_1_INTR_SLAVE_I2C_START - I2C slave received Start 
*     condition.
*   - SCB_1_INTR_SLAVE_I2C_ADDR_MATCH - I2C slave received matching 
*     address.
*   - SCB_1_INTR_SLAVE_I2C_GENERAL - I2C Slave received general 
*     call address.
*   - SCB_1_INTR_SLAVE_I2C_BUS_ERROR - I2C slave bus error (detection 
*      of unexpected Start or Stop condition).
*   - SCB_1_INTR_SLAVE_SPI_BUS_ERROR - SPI slave select line is 
...
/*******************************************************************************
* Function Name: SCB_1_SetSlaveInterruptMode
****************************************************************************//**
*
...
*   SCB_1_GetSlaveInterruptSource() function for bit field values).
*
*******************************************************************************/
#define SCB_1_SetSlaveInterruptMode(interruptMask)   SCB_1_WRITE_INTR_SLAVE_MASK(interruptMask)

/*******************************************************************************
* Function Name: SCB_1_GetSlaveInterruptMode
****************************************************************************//**
*
...
/*******************************************************************************
* Function Name: SCB_1_GetSlaveInterruptSourceMasked
****************************************************************************//**
*
...
*   SCB_1_GetSlaveInterruptSource() function for return values).
*
*******************************************************************************/
#define SCB_1_GetSlaveInterruptSourceMasked()    (SCB_1_INTR_SLAVE_MASKED_REG)

/*******************************************************************************
* Function Name: SCB_1_ClearSlaveInterruptSource
****************************************************************************//**
*
...
/*******************************************************************************
* Function Name: SCB_1_SetSlaveInterrupt
****************************************************************************//**
*
*  Sets Slave interrupt sources in the interrupt request register.
*
*  \param interruptMask: Slave interrupt sources to set in the Slave interrupt 
*   request register (refer to SCB_1_GetSlaveInterruptSource() 
...
#define SCB_1_STATUS_PTR             ( (reg32 *) SCB_1_SCB__STATUS)
    ...
    #define SCB_1_UART_TX_CTRL_PTR       ( (reg32 *) SCB_1_SCB__UART_TX_CTRL)
    ...
    #define SCB_1_UART_FLOW_CTRL_REG     (*(reg32 *) SCB_1_SCB__UART_FLOW_CTRL)
    #define SCB_1_UART_FLOW_CTRL_PTR     ( (reg32 *) SCB_1_SCB__UART_FLOW_CTRL)
...
#ifdef SCB_1_SCB__EZ_DATA0
    #define SCB_1_EZBUF_DATA0_REG    (*(reg32 *) SCB_1_SCB__EZ_DATA0)
    #define SCB_1_EZBUF_DATA0_PTR    ( (reg32 *) SCB_1_SCB__EZ_DATA0)
#else
    #define SCB_1_EZBUF_DATA0_REG    (*(reg32 *) SCB_1_SCB__EZ_DATA00)
    #define SCB_1_EZBUF_DATA0_PTR    ( (reg32 *) SCB_1_SCB__EZ_DATA00)
#endif /* SCB_1_SCB__EZ_DATA00 */
...
#define SCB_1_FIFO_SIZE      (8u)  /* TX or RX FIFO size. */
#define SCB_1_EZ_DATA_NR     (32u)  /* Number of words in EZ memory. */ 
#define SCB_1_ONE_BYTE_WIDTH (8u)            /* Number of bits in one byte. */
#define SCB_1_FF_DATA_NR_LOG2_MASK       (0x0Fu)      /* Number of bits to represent a FIFO address. */
#define SCB_1_FF_DATA_NR_LOG2_PLUS1_MASK (0x1Fu) /* Number of bits to represent #bytes in FIFO. */
...
#if !(SCB_1_CY_SCBIP_V0 || SCB_1_CY_SCBIP_V1)
    #define SCB_1_CTRL_BYTE_MODE_POS (11u) /* [11]    Determines the number of bits per FIFO data element */
#endif /* !(SCB_1_CY_SCBIP_V0 || SCB_1_CY_SCBIP_V1) */
#define SCB_1_CTRL_ADDR_ACCEPT_POS   (16u) /* [16]    Put matched address in RX FIFO       */
#define SCB_1_CTRL_BLOCK_POS         (17u) /* [17]    Ext and Int logic to resolve collide */
...
#if !(SCB_1_CY_SCBIP_V0 || SCB_1_CY_SCBIP_V1)
    #define SCB_1_CTRL_BYTE_MODE ((uint32) 0x01u << SCB_1_CTRL_BYTE_MODE_POS)
#endif /* !(SCB_1_CY_SCBIP_V0 || SCB_1_CY_SCBIP_V1) */
...
/* SCB_1_STATUS_REG */
#define SCB_1_STATUS_EC_BUSY_POS     (0u)  /* [0] Bus busy. Externally clocked logic access to EZ memory */
...
#if !(SCB_1_CY_SCBIP_V0 || SCB_1_CY_SCBIP_V1)
    #define SCB_1_SPI_CTRL_SCLK_CONTINUOUS_POS   (5u)  /* [5]     Enable continuous SCLK generation */
    #define SCB_1_SPI_CTRL_SSEL0_POLARITY_POS    (8u)  /* [8]     SS0 polarity                      */
    #define SCB_1_SPI_CTRL_SSEL1_POLARITY_POS    (9u)  /* [9]     SS1 polarity                      */
    #define SCB_1_SPI_CTRL_SSEL2_POLARITY_POS    (10u) /* [10]    SS2 polarity                      */
    #define SCB_1_SPI_CTRL_SSEL3_POLARITY_POS    (11u) /* [11]    SS3 polarity                      */
#endif /* !(SCB_1_CY_SCBIP_V0 || SCB_1_CY_SCBIP_V1) */
#define SCB_1_SPI_CTRL_LOOPBACK_POS          (16u) /* [16]    Local loop-back control enabled            */
...
#if !(SCB_1_CY_SCBIP_V0 || SCB_1_CY_SCBIP_V1)
    #define SCB_1_SPI_CTRL_SCLK_CONTINUOUS  ((uint32) 0x01u << SCB_1_SPI_CTRL_SCLK_CONTINUOUS_POS)
    #define SCB_1_SPI_CTRL_SSEL0_POLARITY   ((uint32) 0x01u << SCB_1_SPI_CTRL_SSEL0_POLARITY_POS)
    #define SCB_1_SPI_CTRL_SSEL1_POLARITY   ((uint32) 0x01u << SCB_1_SPI_CTRL_SSEL1_POLARITY_POS)
    #define SCB_1_SPI_CTRL_SSEL2_POLARITY   ((uint32) 0x01u << SCB_1_SPI_CTRL_SSEL2_POLARITY_POS)
    #define SCB_1_SPI_CTRL_SSEL3_POLARITY   ((uint32) 0x01u << SCB_1_SPI_CTRL_SSEL3_POLARITY_POS)
    #define SCB_1_SPI_CTRL_SSEL_POLARITY_MASK ((uint32)0x0Fu << SCB_1_SPI_CTRL_SSEL0_POLARITY_POS)
#endif /* !(SCB_1_CY_SCBIP_V0 || SCB_1_CY_SCBIP_V1) */
...
/* SCB_1_UART_CTRL */
#define SCB_1_UART_CTRL_LOOPBACK_POS         (16u) /* [16] Loop-back    */
...
/* SCB_1_UART_RX_CTRL */
#define SCB_1_UART_RX_CTRL_STOP_BITS_POS             (0u)  /* [2:0] Stop bits: (Stop bits + 1) * 0.5 period*/
...
#define SCB_1_UART_RX_CTRL_LIN_MODE_POS              (12u) /* [12]  Lin mode: applicable for UART Standard */
#define SCB_1_UART_RX_CTRL_SKIP_START_POS            (13u) /* [13]  Skip start not: only for UART Standard */
...
#define SCB_1_UART_RX_STATUS_BR_COUNTER_POS     (0u)  /* [11:0] Baud Rate counter */
#define SCB_1_UART_RX_STATUS_BR_COUNTER_MASK    ((uint32) 0xFFFu)

#if !(SCB_1_CY_SCBIP_V0 || SCB_1_CY_SCBIP_V1)
    /* SCB_1_UART_FLOW_CTRL_REG */
    #define SCB_1_UART_FLOW_CTRL_TRIGGER_LEVEL_POS    (0u)  /* [7:0] RTS RX FIFO trigger level         */
    #define SCB_1_UART_FLOW_CTRL_RTS_POLARITY_POS     (16u) /* [16]  Polarity of the RTS output signal */
    #define SCB_1_UART_FLOW_CTRL_CTS_POLARITY_POS     (24u) /* [24]  Polarity of the CTS input signal  */
    #define SCB_1_UART_FLOW_CTRL_CTS_ENABLED_POS      (25u) /* [25]  Enable CTS signal                 */
    #define SCB_1_UART_FLOW_CTRL_TRIGGER_LEVEL_MASK   ((uint32) SCB_1_FF_DATA_NR_LOG2_MASK)
    #define SCB_1_UART_FLOW_CTRL_RTS_POLARITY         ((uint32) 0x01u << \
                                                                       SCB_1_UART_FLOW_CTRL_RTS_POLARITY_POS)
    #define SCB_1_UART_FLOW_CTRL_CTS_POLARITY         ((uint32) 0x01u << \
                                                                       SCB_1_UART_FLOW_CTRL_CTS_POLARITY_POS)
    #define SCB_1_UART_FLOW_CTRL_CTS_ENABLE           ((uint32) 0x01u << \
                                                                       SCB_1_UART_FLOW_CTRL_CTS_ENABLED_POS)
#endif /* !(SCB_1_CY_SCBIP_V0 || SCB_1_CY_SCBIP_V1) */

/* SCB_1_I2C_CTRL */
#define SCB_1_I2C_CTRL_HIGH_PHASE_OVS_POS           (0u)   /* [3:0] Oversampling factor high: master only */
#define SCB_1_I2C_CTRL_LOW_PHASE_OVS_POS            (4u)   /* [7:4] Oversampling factor low:  master only */
#define SCB_1_I2C_CTRL_M_READY_DATA_ACK_POS         (8u)   /* [8]   Master ACKs data while RX FIFO != FULL*/
...
#define SCB_1_I2C_CTRL_LOOPBACK_POS                 (16u)  /* [16]  Loop-back                             */
...
#define SCB_1_I2C_CFG_SDA_FILT_OUT_HS_POS        (26u) /* [26]    '0': 50 ns filter, '1': 10 ns filter     */
#define SCB_1_I2C_CFG_SDA_FILT_OUT_ENABLED_POS   (27u) /* [27]    I2C SDA output delay filter enabled      */
#define SCB_1_I2C_CFG_SDA_FILT_HYS_MASK          ((uint32) 0x03u)
...
#else
#define SCB_1_I2C_CFG_SDA_IN_FILT_TRIM_POS   (0u)  /* [1:0] Trim bits for "i2c_sda_in" 50 ns filter */
#define SCB_1_I2C_CFG_SDA_IN_FILT_SEL_POS    (4u)  /* [4]   "i2c_sda_in" filter delay: 0 ns and 50 ns */
#define SCB_1_I2C_CFG_SCL_IN_FILT_TRIM_POS   (8u)  /* [9:8] Trim bits for "i2c_scl_in" 50 ns filter */
#define SCB_1_I2C_CFG_SCL_IN_FILT_SEL_POS    (12u) /* [12]  "i2c_scl_in" filter delay: 0 ns and 50 ns */
#define SCB_1_I2C_CFG_SDA_OUT_FILT0_TRIM_POS (16u) /* [17:16] Trim bits for "i2c_sda_out" 50 ns filter 0 */
#define SCB_1_I2C_CFG_SDA_OUT_FILT1_TRIM_POS (18u) /* [19:18] Trim bits for "i2c_sda_out" 50 ns filter 1 */
#define SCB_1_I2C_CFG_SDA_OUT_FILT2_TRIM_POS (20u) /* [21:20] Trim bits for "i2c_sda_out" 50 ns filter 2 */
#define SCB_1_I2C_CFG_SDA_OUT_FILT_SEL_POS   (28u) /* [29:28] Cumulative "i2c_sda_out" filter delay: */

#define SCB_1_I2C_CFG_SDA_IN_FILT_TRIM_MASK  ((uint32) 0x03u)
#define SCB_1_I2C_CFG_SDA_IN_FILT_SEL        ((uint32) 0x01u << SCB_1_I2C_CFG_SDA_IN_FILT_SEL_POS)
#define SCB_1_I2C_CFG_SCL_IN_FILT_TRIM_MASK  ((uint32) 0x03u << \
                                                            SCB_1_I2C_CFG_SCL_IN_FILT_TRIM_POS)
#define SCB_1_I2C_CFG_SCL_IN_FILT_SEL        ((uint32) 0x01u << SCB_1_I2C_CFG_SCL_IN_FILT_SEL_POS)
#define SCB_1_I2C_CFG_SDA_OUT_FILT0_TRIM_MASK ((uint32) 0x03u << \
                                                            SCB_1_I2C_CFG_SDA_OUT_FILT0_TRIM_POS)
#define SCB_1_I2C_CFG_SDA_OUT_FILT1_TRIM_MASK ((uint32) 0x03u << \
                                                            SCB_1_I2C_CFG_SDA_OUT_FILT1_TRIM_POS)
#define SCB_1_I2C_CFG_SDA_OUT_FILT2_TRIM_MASK ((uint32) 0x03u << \
                                                            SCB_1_I2C_CFG_SDA_OUT_FILT2_TRIM_POS)
#define SCB_1_I2C_CFG_SDA_OUT_FILT_SEL_MASK   ((uint32) 0x03u << \
                                                            SCB_1_I2C_CFG_SDA_OUT_FILT_SEL_POS)
#endif /* (SCB_1_CY_SCBIP_V0) */


/* SCB_1_TX_CTRL_REG */
#define SCB_1_TX_CTRL_DATA_WIDTH_POS     (0u)  /* [3:0] Data frame width: (Data width - 1) */
...
#define SCB_1_TX_FIFO_CTRL_CLEAR_POS             (16u) /* [16]  Clear TX FIFO: cleared after set           */
#define SCB_1_TX_FIFO_CTRL_FREEZE_POS            (17u) /* [17]  Freeze TX FIFO: HW do not inc read pointer */
#define SCB_1_TX_FIFO_CTRL_TRIGGER_LEVEL_MASK    ((uint32) SCB_1_FF_DATA_NR_LOG2_MASK)
...
#define SCB_1_TX_FIFO_STATUS_USED_MASK   ((uint32) SCB_1_FF_DATA_NR_LOG2_PLUS1_MASK)
#define SCB_1_TX_FIFO_SR_VALID           ((uint32) 0x01u << SCB_1_TX_FIFO_SR_VALID_POS)
#define SCB_1_TX_FIFO_STATUS_RD_PTR_MASK ((uint32) SCB_1_FF_DATA_NR_LOG2_MASK << \
                                                                    SCB_1_TX_FIFO_STATUS_RD_PTR_POS)
#define SCB_1_TX_FIFO_STATUS_WR_PTR_MASK ((uint32) SCB_1_FF_DATA_NR_LOG2_MASK << \
                                                                    SCB_1_TX_FIFO_STATUS_WR_PTR_POS)
...
/* SCB_1_RX_CTRL_REG */
#define SCB_1_RX_CTRL_DATA_WIDTH_POS     (0u)  /* [3:0] Data frame width: (Data width - 1) */
...
#define SCB_1_RX_FIFO_CTRL_CLEAR_POS             (16u)  /* [16]  Clear RX FIFO: clear after set           */
#define SCB_1_RX_FIFO_CTRL_FREEZE_POS            (17u)  /* [17]  Freeze RX FIFO: HW writes has not effect */
#define SCB_1_RX_FIFO_CTRL_TRIGGER_LEVEL_MASK    ((uint32) SCB_1_FF_DATA_NR_LOG2_MASK)
...
#define SCB_1_RX_FIFO_STATUS_USED_MASK   ((uint32) SCB_1_FF_DATA_NR_LOG2_PLUS1_MASK)
#define SCB_1_RX_FIFO_SR_VALID           ((uint32) 0x01u << SCB_1_RX_FIFO_SR_VALID_POS)
#define SCB_1_RX_FIFO_STATUS_RD_PTR_MASK ((uint32) SCB_1_FF_DATA_NR_LOG2_MASK << \
                                                                    SCB_1_RX_FIFO_STATUS_RD_PTR_POS)
#define SCB_1_RX_FIFO_STATUS_WR_PTR_MASK ((uint32) SCB_1_FF_DATA_NR_LOG2_MASK << \
                                                                    SCB_1_RX_FIFO_STATUS_WR_PTR_POS)
...
#define SCB_1_INTR_MASTER_SPI_DONE_POS       (9u)  /* [9] Master complete transfer: Only for SPI           */
...
#define SCB_1_INTR_SLAVE_I2C_STOP_POS             (4u)  /* [4]  Slave detects end of transaction intended */
...
#define SCB_1_INTR_SLAVE_SPI_EZBUF_STOP_POS       (10u) /* [10] Slave end of transaction: Only for SPI   */
...
#define SCB_1_INTR_TX_FIFO_LEVEL         (SCB_1_INTR_TX_TRIGGER)
...
#define SCB_1_INTR_RX_BAUD_DETECT_POS    (10u)  /* [10] LIN baud rate detection is completed   */
#define SCB_1_INTR_RX_BREAK_DETECT_POS   (11u)  /* [11] Break detection is successful         */
#define SCB_1_INTR_RX_TRIGGER            ((uint32) 0x01u)
#define SCB_1_INTR_RX_FIFO_LEVEL         (SCB_1_INTR_RX_TRIGGER)
...
*/
#define SCB_1_SCB_SW_RESET   SCB_1_I2CFwBlockReset()
...
/* Return true if sourceMask is set in SCB_1_CTRL_REG: generally is used to check enable bit */
...
#define SCB_1_DISABLE_AUTO_DATA \
                do{                        \
                    SCB_1_I2C_CTRL_REG &= ((uint32) ~(SCB_1_I2C_CTRL_M_READY_DATA_ACK      |  \
                                                                 SCB_1_I2C_CTRL_M_NOT_READY_DATA_NACK |  \
                                                                 SCB_1_I2C_CTRL_S_READY_DATA_ACK      |  \
                                                                 SCB_1_I2C_CTRL_S_NOT_READY_DATA_NACK)); \
                }while(0)
...
#define SCB_1_I2C_SLAVE_GENERATE_ACK \
    ...
    #define SCB_1_I2C_SLAVE_GENERATE_NACK SCB_1_I2CSlaveNackGeneration()
...
#define SCB_1_DIGITAL_FILTER_DISABLE    (0u)
#define SCB_1_DIGITAL_FILTER_ENABLE     (1u)
#define SCB_1_I2C_DATA_RATE_FS_MODE_MAX (400u)
#if (SCB_1_CY_SCBIP_V0)
    /* SCB_1_I2C_CFG_SDA_FILT_OUT_ENABLED is disabled by default */
    #define SCB_1_I2C_CFG_FILT_MASK  (SCB_1_I2C_CFG_SDA_FILT_ENABLED | \
                                                 SCB_1_I2C_CFG_SCL_FILT_ENABLED)
#else
    /* SCB_1_I2C_CFG_SDA_OUT_FILT_SEL_MASK is disabled by default */
    #define SCB_1_I2C_CFG_FILT_MASK  (SCB_1_I2C_CFG_SDA_IN_FILT_SEL | \
                                                 SCB_1_I2C_CFG_SCL_IN_FILT_SEL)
#endif /* (SCB_1_CY_SCBIP_V0) */

#define SCB_1_I2C_CFG_ANALOG_FITER_DISABLE \
        do{                                           \
            SCB_1_I2C_CFG_REG &= (uint32) ~SCB_1_I2C_CFG_FILT_MASK; \
        }while(0)

#define SCB_1_I2C_CFG_ANALOG_FITER_ENABLE \
        do{                                          \
            SCB_1_I2C_CFG_REG |= (uint32)  SCB_1_I2C_CFG_FILT_MASK; \
        }while(0)
...
/* Return FIFO size depends on SCB_1_CTRL_BYTE_MODE bit */
#define SCB_1_GET_FIFO_SIZE(condition) ((0u != (condition)) ? \
                                                    (2u * SCB_1_FIFO_SIZE) : (SCB_1_FIFO_SIZE))
...
#if (SCB_1_CY_SCBIP_V0 || SCB_1_CY_SCBIP_V1)
    #define SCB_1_GET_CTRL_BYTE_MODE(mode)   (0u)
#else
    #define SCB_1_GET_CTRL_BYTE_MODE(mode)   ((0u != (mode)) ? \
                                                            (SCB_1_CTRL_BYTE_MODE) : (0u))
#endif /* (SCB_1_CY_SCBIP_V0 || SCB_1_CY_SCBIP_V1) */
...
#define SCB_1_GET_I2C_CTRL_S_GENERAL_IGNORE(genCall) ((0u != (genCall)) ? \
                                                                    (SCB_1_I2C_CTRL_S_GENERAL_IGNORE) : (0u))

#define SCB_1_GET_I2C_CTRL_SL_MSTR_MODE(mode)    ((uint32)(mode) << SCB_1_I2C_CTRL_SLAVE_MODE_POS)
...
#define SCB_1_GET_SPI_CTRL_SCLK_MODE(mode)       (((uint32) (mode) << \
...
#if (SCB_1_CY_SCBIP_V0 || SCB_1_CY_SCBIP_V1)
    #define SCB_1_GET_SPI_CTRL_SCLK_CONTINUOUS(sclkType) (0u)
    #define SCB_1_GET_SPI_CTRL_SSEL_POLARITY(polarity)   (0u)
#else
    #define SCB_1_GET_SPI_CTRL_SCLK_CONTINUOUS(sclkType) ((0u != (sclkType)) ? \
                                                                    (SCB_1_SPI_CTRL_SCLK_CONTINUOUS) : (0u))

    #define SCB_1_GET_SPI_CTRL_SSEL_POLARITY(polarity)   (((uint32) (polarity) << \
                                                                     SCB_1_SPI_CTRL_SSEL0_POLARITY_POS) & \
                                                                     SCB_1_SPI_CTRL_SSEL_POLARITY_MASK)
#endif /* ((SCB_1_CY_SCBIP_V0 || SCB_1_CY_SCBIP_V1) */

#define SCB_1_GET_SPI_CTRL_SUB_MODE(mode)        (((uint32) (mode) << SCB_1_SPI_CTRL_MODE_POS) & \
...
/* SCB_1_UART_CTRL */
#define SCB_1_GET_UART_CTRL_MODE(mode)           (((uint32) (mode) << \
...
#define SCB_1_GET_UART_RX_CTRL_BREAK_WIDTH(width)    (((uint32) ((uint32) (width) - 1u) << \
                                                                    SCB_1_UART_RX_CTRL_BREAK_WIDTH_POS) & \
                                                                    SCB_1_UART_RX_CTRL_BREAK_WIDTH_MASK)
...
/* SCB_1_UART_FLOW_CTRL */
#if !(SCB_1_CY_SCBIP_V0 || SCB_1_CY_SCBIP_V1)
    #define SCB_1_GET_UART_FLOW_CTRL_TRIGGER_LEVEL(level)   ( (uint32) (level) & \
                                                                 SCB_1_UART_FLOW_CTRL_TRIGGER_LEVEL_MASK)

    #define SCB_1_GET_UART_FLOW_CTRL_RTS_POLARITY(polarity) ((0u != (polarity)) ? \
                                                                (SCB_1_UART_FLOW_CTRL_RTS_POLARITY) : (0u))

    #define SCB_1_GET_UART_FLOW_CTRL_CTS_POLARITY(polarity) ((0u != (polarity)) ? \
                                                                (SCB_1_UART_FLOW_CTRL_CTS_POLARITY) : (0u))

    #define SCB_1_GET_UART_FLOW_CTRL_CTS_ENABLE(ctsEn)      ((0u != (ctsEn)) ? \
                                                                (SCB_1_UART_FLOW_CTRL_CTS_ENABLE) : (0u))
#endif /* !(SCB_1_CY_SCBIP_V0 || SCB_1_CY_SCBIP_V1) */
...
#define SCB_1_GET_RX_MATCH_MASK(mask)    (((uint32) (mask) << \
...
/* SCB_1_INTR_SLAVE_I2C_GENERAL */
#define SCB_1_GET_INTR_SLAVE_I2C_GENERAL(genCall)  ((0u != (genCall)) ? \
                                                                (SCB_1_INTR_SLAVE_I2C_GENERAL) : (0u))

/* Return true if master mode is enabled SCB_1_SPI_CTRL_REG */
#define SCB_1_CHECK_SPI_MASTER   (0u != (SCB_1_SPI_CTRL_REG & SCB_1_SPI_CTRL_MASTER))

/* Return inactive state of SPI SCLK line depends on CPOL */
#define SCB_1_GET_SPI_SCLK_INACTIVE \
            ((0u == (SCB_1_SPI_CTRL_REG & SCB_1_SPI_CTRL_CPOL)) ? (0u) : (1u))

/* Get output pin inactive state */
#if (SCB_1_CY_SCBIP_V0 || SCB_1_CY_SCBIP_V1)
#define SCB_1_GET_SPI_SS0_INACTIVE       (1u)
#define SCB_1_GET_SPI_SS1_INACTIVE       (1u)
#define SCB_1_GET_SPI_SS2_INACTIVE       (1u)
#define SCB_1_GET_SPI_SS3_INACTIVE       (1u)
#define SCB_1_GET_UART_RTS_INACTIVE      (1u)

#else
#define SCB_1_GET_SPI_SS0_INACTIVE  \
        ((0u != (SCB_1_SPI_CTRL_REG & SCB_1_SPI_CTRL_SSEL0_POLARITY)) ? (0u) : (1u))

#define SCB_1_GET_SPI_SS1_INACTIVE  \
        ((0u != (SCB_1_SPI_CTRL_REG & SCB_1_SPI_CTRL_SSEL1_POLARITY)) ? (0u) : (1u))

#define SCB_1_GET_SPI_SS2_INACTIVE  \
        ((0u != (SCB_1_SPI_CTRL_REG & SCB_1_SPI_CTRL_SSEL2_POLARITY)) ? (0u) : (1u))

#define SCB_1_GET_SPI_SS3_INACTIVE  \
        ((0u != (SCB_1_SPI_CTRL_REG & SCB_1_SPI_CTRL_SSEL3_POLARITY)) ? (0u) : (1u))

#define SCB_1_GET_UART_RTS_INACTIVE \
        ((0u == (SCB_1_UART_FLOW_CTRL_REG & SCB_1_UART_FLOW_CTRL_RTS_POLARITY)) ? (0u) : (1u))
...
#define SCB_1_CY_SCBIP_V1_I2C_ONLY   (SCB_1_CY_SCBIP_V1)
#define SCB_1_EZBUFFER_SIZE          (SCB_1_EZ_DATA_NR)

#define SCB_1_EZBUF_DATA00_REG   SCB_1_EZBUF_DATA0_REG
#define SCB_1_EZBUF_DATA00_PTR   SCB_1_EZBUF_DATA0_PTR
