...
typedef struct
{
     ...
     *  - SCB_2_I2C_MODE_SLAVE
     *  - SCB_2_I2C_MODE_MASTER
     *  - SCB_2_I2C_MODE_MULTI_MASTER
     *  - SCB_2_I2C_MODE_MULTI_MASTER_SLAVE
    */
    uint32 mode;
...
/* I2C Master functions prototypes */
    ...
    uint32 SCB_2_I2CMasterSendStart(uint32 slaveAddress, uint32 bitRnW, uint32 timeoutMs);
    uint32 SCB_2_I2CMasterSendRestart(uint32 slaveAddress, uint32 bitRnW, uint32 timeoutMs);
    uint32 SCB_2_I2CMasterSendStop(uint32 timeoutMs);
    uint32 SCB_2_I2CMasterWriteByte(uint32 wrByte, uint32 timeoutMs);
    uint32 SCB_2_I2CMasterReadByte(uint32 ackNack, uint8* rdByte, uint32 timeoutMs);
...
#define SCB_2_I2C_MSTR_ERR_TIMEOUT       (SCB_2_I2C_MASTER_TIMEOUT) /* Operation timeout        */
...
#define SCB_2_I2C_TX_OVERFLOW_COUNT      (SCB_2_I2C_FIFO_SIZE + 2u)
...
#define SCB_2_I2C_MASTER_TIMEOUT_POS (31u)
#define SCB_2_I2C_MASTER_TIMEOUT     ((uint32) 0x01u << SCB_2_I2C_MASTER_TIMEOUT_POS)

/* Slave address match or general call */
#define SCB_2_SLAVE_INTR_I2C_ADDR    (SCB_2_INTR_SLAVE_I2C_ADDR_MATCH | \
                                                 SCB_2_INTR_SLAVE_I2C_GENERAL)

/* Send byte condition: used by */
#define SCB_2_INTR_MASTER_SEND_BYTE   (SCB_2_INTR_MASTER_I2C_ACK      | \
                                                  SCB_2_INTR_MASTER_I2C_NACK     | \
                                                  SCB_2_INTR_MASTER_I2C_ARB_LOST | \
                                                  SCB_2_INTR_MASTER_I2C_BUS_ERROR)
/* Receive byte error conditions */
#define SCB_2_INTR_MASTER_RECEIVE_BYTE   (SCB_2_INTR_MASTER_I2C_ARB_LOST | \
                                                     SCB_2_INTR_MASTER_I2C_BUS_ERROR)
/* Stop condition */
#define SCB_2_INTR_MASTER_SEND_STOP  (SCB_2_INTR_MASTER_I2C_STOP     | \
                                                 SCB_2_INTR_MASTER_I2C_ARB_LOST | \
                                                 SCB_2_INTR_MASTER_I2C_BUS_ERROR)
...
#define SCB_2_I2C_RX_CTRL    ((SCB_2_ONE_BYTE_WIDTH - 1u) | \
                                          SCB_2_RX_CTRL_MSB_FIRST    | \
                                          SCB_2_RX_CTRL_ENABLED)

#define SCB_2_I2C_TX_CTRL    ((SCB_2_ONE_BYTE_WIDTH - 1u) | \
...
#define SCB_2_I2C_PHASE_GEN_TIMEOUT      (20000u)
...
#define SCB_2_I2C_CONVERT_TIMEOUT_TO_US(timeoutMs)   ((timeoutMs) * 1000u)
...
***************************************/
    ...
    #define SCB_2_I2C_DEFAULT_INTR_MASTER_MASK   (SCB_2_NO_INTR_SOURCES)
