    ...
    const CYBLE_GATTS_T cyBle_gatts =
{
    ...
    static uint8 cyBle_attValues[0x55u] = {
    /* Device Name */
    (uint8)'T', (uint8)'h', (uint8)'e', (uint8)'r', (uint8)'m', (uint8)'o', (uint8)'m', (uint8)'e', (uint8)'t',
    (uint8)'e', (uint8)'r',
    ...
    0x18u, 0x00u, 0x30u, 0x00u, 0x00u, 0x00u, 0x64u, 0x00u,
    ...
    (uint8)'C', (uint8)'Y', (uint8)'8', (uint8)'C', (uint8)'K', (uint8)'I', (uint8)'T', (uint8)'-', (uint8)'0',
    (uint8)'4', (uint8)'2', (uint8)' ', (uint8)'B', (uint8)'L', (uint8)'E',
...
CYBLE_GATTS_ATT_GEN_VAL_LEN_T cyBle_attValuesLen[CYBLE_GATT_DB_ATT_VAL_COUNT] = {
    ...
    { 0x0005u, (void *)&cyBle_attValues[25] }, /* Temperature Measurement */
    { 0x0002u, (void *)&cyBle_attValuesCCCD[2] }, /* Client Characteristic Configuration */
    { 0x0001u, (void *)&cyBle_attValues[30] }, /* Temperature Type */
    { 0x0002u, (void *)&cyBle_attValues[31] }, /* Measurement Interval */
    { 0x0004u, (void *)&cyBle_attValues[33] }, /* Valid Range */
    { 0x0015u, (void *)&cyBle_attValues[37] }, /* Manufacturer Name String */
    { 0x0004u, (void *)&cyBle_attValues[58] }, /* Model Number String */
    { 0x000Fu, (void *)&cyBle_attValues[62] }, /* Hardware Revision String */
    { 0x0001u, (void *)&cyBle_attValues[77] }, /* Battery Level */
    { 0x0007u, (void *)&cyBle_attValues[78] }, /* Characteristic Presentation Format */
...
const CYBLE_GATTS_DB_T cyBle_gattDB[0x20u] = {
    ...
    { 0x000Cu, 0x2800u /* Primary service                     */, 0x00000001u /*        */, 0x0014u, {{0x1809u, NULL}}                           },
    { 0x000Du, 0x2803u /* Characteristic                      */, 0x00200001u /* ind    */, 0x000Fu, {{0x2A1Cu, NULL}}                           },
    { 0x000Eu, 0x2A1Cu /* Temperature Measurement             */, 0x01200000u /* ind    */, 0x000Fu, {{0x0005u, (void *)&cyBle_attValuesLen[5]}} },
    ...
    { 0x0011u, 0x2A1Du /* Temperature Type                    */, 0x01020003u /* rd     */, 0x0011u, {{0x0001u, (void *)&cyBle_attValuesLen[7]}} },
    { 0x0012u, 0x2803u /* Characteristic                      */, 0x000A0001u /* rd,wr  */, 0x0014u, {{0x2A21u, NULL}}                           },
    { 0x0013u, 0x2A21u /* Measurement Interval                */, 0x010A0303u /* rd,wr  */, 0x0014u, {{0x0002u, (void *)&cyBle_attValuesLen[8]}} },
    { 0x0014u, 0x2906u /* Valid Range                         */, 0x01020001u /* rd     */, 0x0014u, {{0x0004u, (void *)&cyBle_attValuesLen[9]}} },
    { 0x0015u, 0x2800u /* Primary service                     */, 0x00000001u /*        */, 0x001Bu, {{0x180Au, NULL}}                           },
    { 0x0016u, 0x2803u /* Characteristic                      */, 0x00020001u /* rd     */, 0x0017u, {{0x2A29u, NULL}}                           },
    { 0x0017u, 0x2A29u /* Manufacturer Name String            */, 0x01020003u /* rd     */, 0x0017u, {{0x0015u, (void *)&cyBle_attValuesLen[10]}} },
    { 0x0018u, 0x2803u /* Characteristic                      */, 0x00020001u /* rd     */, 0x0019u, {{0x2A24u, NULL}}                           },
    { 0x0019u, 0x2A24u /* Model Number String                 */, 0x01020003u /* rd     */, 0x0019u, {{0x0004u, (void *)&cyBle_attValuesLen[11]}} },
    { 0x001Au, 0x2803u /* Characteristic                      */, 0x00020001u /* rd     */, 0x001Bu, {{0x2A27u, NULL}}                           },
    { 0x001Bu, 0x2A27u /* Hardware Revision String            */, 0x01020003u /* rd     */, 0x001Bu, {{0x000Fu, (void *)&cyBle_attValuesLen[12]}} },
    { 0x001Cu, 0x2800u /* Primary service                     */, 0x00000001u /*        */, 0x0020u, {{0x180Fu, NULL}}                           },
    { 0x001Du, 0x2803u /* Characteristic                      */, 0x00120001u /* rd,ntf */, 0x0020u, {{0x2A19u, NULL}}                           },
    { 0x001Eu, 0x2A19u /* Battery Level                       */, 0x01120003u /* rd,ntf */, 0x0020u, {{0x0001u, (void *)&cyBle_attValuesLen[13]}} },
    { 0x001Fu, 0x2904u /* Characteristic Presentation Format  */, 0x01020001u /* rd     */, 0x001Fu, {{0x0007u, (void *)&cyBle_attValuesLen[14]}} },
    { 0x0020u, 0x2902u /* Client Characteristic Configuration */, 0x010A0301u /* rd,wr  */, 0x0020u, {{0x0002u, (void *)&cyBle_attValuesLen[15]}} },
};
