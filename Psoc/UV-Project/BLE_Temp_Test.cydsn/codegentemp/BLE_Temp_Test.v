// ======================================================================
// BLE_Temp_Test.v generated from TopDesign.cysch
// 10/10/2017 at 21:40
...
module ADC_SAR_SEQ_P4_v2_50_1 (
	...
	cy_connect_v1_0 cy_analog_virtualmux_vplus_inj_connect(Net_3016, vinPlusINJ);
...
// DieTemp_P4_v1_0(CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=DieTemp_P4_v1_0, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=DieTemp, CY_INSTANCE_SHORT_NAME=DieTemp, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.1 Update 1, INSTANCE_NAME=DieTemp, )
module DieTemp_P4_v1_0_3 (
    temp);
    inout       temp;
    electrical  temp;
    ...
    cy_psoc4_temp_v1_0 cy_psoc4_temp (
        .temp(temp),
        .vssa_kelvin(Net_3));
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("27e999c3-ee62-4395-9788-c1c8ad92bb59"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
    ...
    cy_annotation_universal_v1_0 C (
        .connect({
            Net_206,
            Net_131
        })
    );
    defparam C.comp_name = "Capacitor_v1_0";
    defparam C.port_names = "T1, T2";
    defparam C.width = 2;
	...
	wire [0:0] tmpOE__A0_1_net;
	wire [0:0] tmpFB_0__A0_1_net;
	wire [0:0] tmpIO_0__A0_1_net;
	wire [0:0] tmpINTERRUPT_0__A0_1_net;
	electrical [0:0] tmpSIOVREF__A0_1_net;
	...
	cy_psoc3_pins_v1_10
		...
		A0_1
		 (.oe(tmpOE__A0_1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__A0_1_net[0:0]}),
		  .analog({Net_210}),
		  .io({tmpIO_0__A0_1_net[0:0]}),
		  .siovref(tmpSIOVREF__A0_1_net),
		  .interrupt({tmpINTERRUPT_0__A0_1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__A0_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
