...
{
    0x0015u,    /* Handle of the DIS service */
    {
        0x0017u, /* Handle of the Manufacturer Name String characteristic */ 
        0x0019u, /* Handle of the Model Number String characteristic */ 
        ...
        CYBLE_GATT_INVALID_ATTR_HANDLE_VALUE, /* Handle of the Firmware Revision String characteristic */ 
        ...
        CYBLE_GATT_INVALID_ATTR_HANDLE_VALUE, /* Handle of the PnP ID characteristic */ 
    },
};
