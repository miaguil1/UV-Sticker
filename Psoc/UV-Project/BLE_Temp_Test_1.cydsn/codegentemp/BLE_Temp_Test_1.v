// ======================================================================
// BLE_Temp_Test_1.v generated from TopDesign.cysch
// 10/20/2017 at 12:57
...
module top ;
	...
	wire [0:0] tmpOE__LowPower_LED_net;
	wire [0:0] tmpFB_0__LowPower_LED_net;
	wire [0:0] tmpIO_0__LowPower_LED_net;
	wire [0:0] tmpINTERRUPT_0__LowPower_LED_net;
	electrical [0:0] tmpSIOVREF__LowPower_LED_net;

	cy_psoc3_pins_v1_10
		#(.id("099c9a51-a3da-403d-9a3d-8076b16c756f"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		LowPower_LED
		 (.oe(tmpOE__LowPower_LED_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LowPower_LED_net[0:0]}),
		  .io({tmpIO_0__LowPower_LED_net[0:0]}),
		  .siovref(tmpSIOVREF__LowPower_LED_net),
		  .interrupt({tmpINTERRUPT_0__LowPower_LED_net[0:0]}),
		  .annotation({Net_17}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__LowPower_LED_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
