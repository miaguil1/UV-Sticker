...
void MeasureBattery(void)
{
    ...
    if(--batteryTimer == 0u) 
    {
        ...
        adcResult = ADC_GetResult16(ADC_TEMPERATURE_CHANNEL);
        ...
        */
        ...
        else
        {
            ...
            apiResult = CyBle_BassSetCharacteristicValue(BAS_SERVICE_MEASURE, CYBLE_BAS_BATTERY_LEVEL, 
                sizeof(batteryLevel), &batteryLevel);
        }
...
void SimulateBattery(void)
{
    ...
    if((CyBle_GattGetBusyStatus() == CYBLE_STACK_STATE_FREE) && (--batteryTimer == 0u))
    {
        ...
        {
            /* Update Battery Level characteristic value and send Notification */
             apiResult = CyBle_BassSendNotification(cyBle_connHandle, BAS_SERVICE_SIMULATE, 
