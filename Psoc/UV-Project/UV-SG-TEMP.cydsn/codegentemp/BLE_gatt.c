...
CYBLE_STATE_T cyBle_state;
    ...
    #endif  /* (__ARMCC_VERSION) */
    {
        ...
        {{
            0x00u, 0x00u,
            0x00u, 0x00u, 0x8Fu, 0xBEu, 0x47u, 0x4Au, 0xC9u, 0x51u, 0x24u, 0x87u, 0x10u, 0x43u, 0x7Au, 0x5Eu, 0x7Cu, 0xCBu,
            0xAFu, 0xF1u,
            0x00u, 0x00u, 0x08u, 0xDAu, 0xA3u, 0xA7u, 0x23u, 0x36u, 0xE5u, 0xBDu, 0x67u, 0x48u, 0x87u, 0xD6u, 0x0Du, 0x4Au,
            0x83u, 0xB1u,
            0x00u, 0x00u, 0x1Eu, 0x62u, 0xCBu, 0xF7u, 0xB4u, 0x74u, 0x77u, 0xB3u, 0x9Eu, 0x4Bu, 0x9Fu, 0x3Du, 0xA4u, 0x0Eu,
            0xFFu, 0xA1u,
            0x00u, 0x00u, 0xF6u, 0x09u, 0x15u, 0xE1u, 0xC8u, 0x5Cu, 0x45u, 0x96u, 0xB0u, 0x46u, 0xB4u, 0x69u, 0xF3u, 0xD8u,
            0x28u, 0x9Eu,
        },
        {
            0x00u, 0x00u,
        ...
        0x4Au, /* CYBLE_GATT_DB_CCCD_COUNT */ 
    ...
    const CYBLE_GATTS_T cyBle_gatts =
{
    ...
    static uint8 cyBle_attValues[0xA8u] = {
    /* Device Name */
    ...
    (uint8)'U', (uint8)'V', (uint8)' ', (uint8)'P', (uint8)'o', (uint8)'w', (uint8)'e', (uint8)'r', (uint8)' ',
    (uint8)'D', (uint8)'e', (uint8)'n', (uint8)'s', (uint8)'i', (uint8)'t', (uint8)'y', 0x38u, 0x03u, 0xABu, 0xE2u,
    0x3Cu, 0x4Au, 0x31u, 0x83u, 0xFEu, 0x4Cu, 0xD9u, 0x66u, 0x77u, 0x66u, 0x4Fu, 0x57u,

    /* UV Index */
    0x00u, 0x10u, 0x11u, 0x22u, 0x33u, 0xFCu, 0x03u,

    /* Characteristic User Description */
    (uint8)'U', (uint8)'V', (uint8)' ', (uint8)'I', (uint8)'n', (uint8)'d', (uint8)'e', (uint8)'x', 0x0Cu, 0x1Fu, 0xAEu,
    0xB4u, 0x9Au, 0xF6u, 0xF7u, 0xB9u, 0x16u, 0x4Au, 0x40u, 0x42u, 0x65u, 0x19u, 0xF4u, 0x29u,

    /* Battery Level */
    0x64u, 0x25u, 0x24u, 0x23u,

    /* Characteristic User Description */
    (uint8)'B', (uint8)'a', (uint8)'t', (uint8)'t', (uint8)'e', (uint8)'r', (uint8)'y', (uint8)' ', (uint8)'L',
    (uint8)'e', (uint8)'v', (uint8)'e', (uint8)'l', 0x94u, 0xFAu, 0x21u, 0x22u, 0xA7u, 0xBEu, 0xD4u, 0x9Au, 0x69u,
    0x4Eu, 0x37u, 0xA6u, 0xDDu, 0xB4u, 0x79u, 0x4Fu,

    /* Temperature */
    0x10u, 0x11u, 0x12u, 0x13u, 0x14u, 0x30u, 0x01u,

    /* Characteristic User Description */
    (uint8)'B', (uint8)'o', (uint8)'d', (uint8)'y', (uint8)' ', (uint8)'T', (uint8)'e', (uint8)'m', (uint8)'p',
    (uint8)'e', (uint8)'r', (uint8)'a', (uint8)'t', (uint8)'u', (uint8)'r', (uint8)'e', 0x1Bu, 0xB8u, 0xD7u, 0x0Eu,
    0xCDu, 0x16u, 0x95u, 0xA2u, 0xE2u, 0x4Fu, 0x55u, 0x12u, 0x27u, 0x3Fu, 0xDEu, 0x5Du,
...
const uint8 cyBle_attUuid128[][16u] = {
    /* UV Measurement */
    { 0xFBu, 0x34u, 0x9Bu, 0x5Fu, 0x80u, 0x00u, 0x00u, 0x80u, 0x00u, 0x10u, 0x00u, 0x00u, 0x42u, 0xDBu, 0x00u, 0x00u },
    /* Power Density */
    { 0xFBu, 0x34u, 0x9Bu, 0x5Fu, 0x80u, 0x00u, 0x00u, 0x80u, 0x00u, 0x10u, 0x00u, 0x00u, 0xCBu, 0xE5u, 0x00u, 0x00u },
    /* UV Index */
    { 0xFBu, 0x34u, 0x9Bu, 0x5Fu, 0x80u, 0x00u, 0x00u, 0x80u, 0x00u, 0x10u, 0x00u, 0x00u, 0xC2u, 0xC3u, 0x00u, 0x00u },
    /* Battery */
    { 0xFBu, 0x34u, 0x9Bu, 0x5Fu, 0x80u, 0x00u, 0x00u, 0x80u, 0x00u, 0x10u, 0x00u, 0x00u, 0x96u, 0x5Cu, 0x00u, 0x00u },
    /* Battery Level */
    { 0xFBu, 0x34u, 0x9Bu, 0x5Fu, 0x80u, 0x00u, 0x00u, 0x80u, 0x00u, 0x10u, 0x00u, 0x00u, 0x22u, 0x69u, 0x00u, 0x00u },
    /* Body Temperature */
    { 0xFBu, 0x34u, 0x9Bu, 0x5Fu, 0x80u, 0x00u, 0x00u, 0x80u, 0x00u, 0x10u, 0x00u, 0x00u, 0xD4u, 0x8Cu, 0x00u, 0x00u },
    /* Temperature */
    { 0xFBu, 0x34u, 0x9Bu, 0x5Fu, 0x80u, 0x00u, 0x00u, 0x80u, 0x00u, 0x10u, 0x00u, 0x00u, 0xAAu, 0x46u, 0x00u, 0x00u },
};
...
CYBLE_GATTS_ATT_GEN_VAL_LEN_T cyBle_attValuesLen[CYBLE_GATT_DB_ATT_VAL_COUNT] = {
    ...
    { 0x0010u, (void *)&cyBle_attUuid128[0] }, /* UV Measurement UUID */
    { 0x0010u, (void *)&cyBle_attUuid128[1] }, /* Power Density UUID */
    { 0x0007u, (void *)&cyBle_attValues[26] }, /* Power Density */
    { 0x0002u, (void *)&cyBle_attValuesCCCD[2] }, /* Client Characteristic Configuration */
    { 0x0010u, (void *)&cyBle_attValues[33] }, /* Characteristic User Description */
    { 0x0010u, (void *)&cyBle_attUuid128[2] }, /* UV Index UUID */
    { 0x0007u, (void *)&cyBle_attValues[65] }, /* UV Index */
    { 0x0002u, (void *)&cyBle_attValuesCCCD[20] }, /* Client Characteristic Configuration */
    { 0x0008u, (void *)&cyBle_attValues[72] }, /* Characteristic User Description */
    { 0x0010u, (void *)&cyBle_attUuid128[3] }, /* Battery UUID */
    { 0x0010u, (void *)&cyBle_attUuid128[4] }, /* Battery Level UUID */
    { 0x0004u, (void *)&cyBle_attValues[96] }, /* Battery Level */
    { 0x0002u, (void *)&cyBle_attValuesCCCD[38] }, /* Client Characteristic Configuration */
    { 0x000Du, (void *)&cyBle_attValues[100] }, /* Characteristic User Description */
    { 0x0010u, (void *)&cyBle_attUuid128[5] }, /* Body Temperature UUID */
    { 0x0010u, (void *)&cyBle_attUuid128[6] }, /* Temperature UUID */
    { 0x0007u, (void *)&cyBle_attValues[129] }, /* Temperature */
    { 0x0002u, (void *)&cyBle_attValuesCCCD[56] }, /* Client Characteristic Configuration */
    { 0x0010u, (void *)&cyBle_attValues[136] }, /* Characteristic User Description */
};
...
const CYBLE_GATTS_DB_T cyBle_gattDB[0x22u] = {
    ...
    { 0x0010u, 0x2800u /* Primary service                     */, 0x08000001u /*        */, 0x0018u, {{0x0010u, (void *)&cyBle_attValuesLen[7]}} },
    { 0x0011u, 0x2803u /* Characteristic                      */, 0x00120001u /* rd,ntf */, 0x0014u, {{0x0010u, (void *)&cyBle_attValuesLen[8]}} },
    { 0x0012u, 0xE5CBu /* Power Density                       */, 0x09120001u /* rd,ntf */, 0x0014u, {{0x0007u, (void *)&cyBle_attValuesLen[9]}} },
    { 0x0013u, 0xCB7Cu /* Client Characteristic Configuration */, 0x090A0101u /* rd,wr  */, 0x0013u, {{0x0002u, (void *)&cyBle_attValuesLen[10]}} },
    { 0x0014u, 0x6677u /* Characteristic User Description     */, 0x09020001u /* rd     */, 0x0014u, {{0x0010u, (void *)&cyBle_attValuesLen[11]}} },
    { 0x0015u, 0x2803u /* Characteristic                      */, 0x00120001u /* rd,ntf */, 0x0018u, {{0x0010u, (void *)&cyBle_attValuesLen[12]}} },
    { 0x0016u, 0xC3C2u /* UV Index                            */, 0x09120001u /* rd,ntf */, 0x0018u, {{0x0007u, (void *)&cyBle_attValuesLen[13]}} },
    { 0x0017u, 0x4A0Du /* Client Characteristic Configuration */, 0x090A0101u /* rd,wr  */, 0x0017u, {{0x0002u, (void *)&cyBle_attValuesLen[14]}} },
    { 0x0018u, 0x1965u /* Characteristic User Description     */, 0x09020001u /* rd     */, 0x0018u, {{0x0008u, (void *)&cyBle_attValuesLen[15]}} },
    { 0x0019u, 0x2800u /* Primary service                     */, 0x08000001u /*        */, 0x001Du, {{0x0010u, (void *)&cyBle_attValuesLen[16]}} },
    { 0x001Au, 0x2803u /* Characteristic                      */, 0x00120001u /* rd,ntf */, 0x001Du, {{0x0010u, (void *)&cyBle_attValuesLen[17]}} },
    { 0x001Bu, 0x6922u /* Battery Level                       */, 0x09120001u /* rd,ntf */, 0x001Du, {{0x0004u, (void *)&cyBle_attValuesLen[18]}} },
    { 0x001Cu, 0x0EA4u /* Client Characteristic Configuration */, 0x090A0101u /* rd,wr  */, 0x001Cu, {{0x0002u, (void *)&cyBle_attValuesLen[19]}} },
    { 0x001Du, 0xB4DDu /* Characteristic User Description     */, 0x09020001u /* rd     */, 0x001Du, {{0x000Du, (void *)&cyBle_attValuesLen[20]}} },
    { 0x001Eu, 0x2800u /* Primary service                     */, 0x08000001u /*        */, 0x0022u, {{0x0010u, (void *)&cyBle_attValuesLen[21]}} },
    { 0x001Fu, 0x2803u /* Characteristic                      */, 0x00120001u /* rd,ntf */, 0x0022u, {{0x0010u, (void *)&cyBle_attValuesLen[22]}} },
    { 0x0020u, 0x46AAu /* Temperature                         */, 0x09120001u /* rd,ntf */, 0x0022u, {{0x0007u, (void *)&cyBle_attValuesLen[23]}} },
    { 0x0021u, 0xD8F3u /* Client Characteristic Configuration */, 0x090A0101u /* rd,wr  */, 0x0021u, {{0x0002u, (void *)&cyBle_attValuesLen[24]}} },
    { 0x0022u, 0x3F27u /* Characteristic User Description     */, 0x09020001u /* rd     */, 0x0022u, {{0x0010u, (void *)&cyBle_attValuesLen[25]}} },
};
