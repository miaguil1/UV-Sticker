...
// OpAmp_P4_v1_20(Compensation=3, DeepSleepSupport=false, Mode=0, OutputCurrent=1, Power=3, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMMENT=, CY_COMPONENT_NAME=OpAmp_P4_v1_20, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=SG_AMP, CY_INSTANCE_SHORT_NAME=SG_AMP, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=20, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.1 Update 1, INSTANCE_NAME=SG_AMP, )
module OpAmp_P4_v1_20_0 (
    Vplus,
    Vout,
    Vminus);
    inout       Vplus;
...
module ADC_SAR_SEQ_P4_v2_50_3 (
	...
	cy_clock_v1_0
		#(.id("1142ff68-4501-4db6-9e99-79befa25a982/5c71752a-e182-47ca-942c-9cb20adbdf2f"),
		  .source_clock_id(""),
		  .divisor(0),
...
// OpAmp_P4_v1_20(Compensation=3, DeepSleepSupport=false, Mode=0, OutputCurrent=1, Power=2, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMMENT=, CY_COMPONENT_NAME=OpAmp_P4_v1_20, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=UV5_AMP, CY_INSTANCE_SHORT_NAME=UV5_AMP, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=20, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.1 Update 1, INSTANCE_NAME=UV5_AMP, )
...
module top ;
    ...
    OpAmp_P4_v1_20_0 SG_AMP (
        .Vplus(Net_1),
        .Vout(Net_306),
        .Vminus(Net_2));

	wire [0:0] tmpOE__SG1_A_net;
	wire [0:0] tmpFB_0__SG1_A_net;
	wire [0:0] tmpIO_0__SG1_A_net;
	wire [0:0] tmpINTERRUPT_0__SG1_A_net;
	electrical [0:0] tmpSIOVREF__SG1_A_net;

	cy_psoc3_pins_v1_10
		#(.id("093cd6f8-bf83-497a-8c39-2862f59bdb04"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		SG1_A
		 (.oe(tmpOE__SG1_A_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__SG1_A_net[0:0]}),
		  .analog({Net_1}),
		  .io({tmpIO_0__SG1_A_net[0:0]}),
		  .siovref(tmpSIOVREF__SG1_A_net),
		  .interrupt({tmpINTERRUPT_0__SG1_A_net[0:0]}),
		  .annotation({Net_4189}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__SG1_A_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__SG2_A_net;
	wire [0:0] tmpFB_0__SG2_A_net;
	wire [0:0] tmpIO_0__SG2_A_net;
	wire [0:0] tmpINTERRUPT_0__SG2_A_net;
	electrical [0:0] tmpSIOVREF__SG2_A_net;

	cy_psoc3_pins_v1_10
		#(.id("466d91b6-9894-4add-a64e-459828fc14a1"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		SG2_A
		 (.oe(tmpOE__SG2_A_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__SG2_A_net[0:0]}),
		  .analog({Net_2}),
		  .io({tmpIO_0__SG2_A_net[0:0]}),
		  .siovref(tmpSIOVREF__SG2_A_net),
		  .interrupt({tmpINTERRUPT_0__SG2_A_net[0:0]}),
		  .annotation({Net_4167}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__SG2_A_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__GAIN_net;
	wire [0:0] tmpFB_0__GAIN_net;
	wire [0:0] tmpIO_0__GAIN_net;
	wire [0:0] tmpINTERRUPT_0__GAIN_net;
	electrical [0:0] tmpSIOVREF__GAIN_net;

	cy_psoc3_pins_v1_10
		#(.id("584bbdf8-0383-46b8-b35b-e4f8f67999d6"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		GAIN
		 (.oe(tmpOE__GAIN_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__GAIN_net[0:0]}),
		  .analog({Net_306}),
		  .io({tmpIO_0__GAIN_net[0:0]}),
		  .siovref(tmpSIOVREF__GAIN_net),
		  .interrupt({tmpINTERRUPT_0__GAIN_net[0:0]}),
		  .annotation({Net_4175}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__GAIN_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    cy_annotation_universal_v1_0 RX (
        .connect({
            Net_4147,
            Net_4183
        })
    );
    defparam RX.comp_name = "Resistor_v1_0";
    defparam RX.port_names = "T1, T2";
    defparam RX.width = 2;
    ...
    cy_annotation_universal_v1_0 R7 (
        .connect({
            Net_4167,
            Net_4175
        })
    );
    defparam R7.comp_name = "Resistor_v1_0";
    defparam R7.port_names = "T1, T2";
    defparam R7.width = 2;

    cy_annotation_universal_v1_0 R8 (
        .connect({
            Net_4186,
            Net_4189
        })
    );
    defparam R8.comp_name = "Resistor_v1_0";
    defparam R8.port_names = "T1, T2";
    defparam R8.width = 2;
	...
	wire [0:0] tmpOE__UVD_5NEG_net;
	wire [0:0] tmpFB_0__UVD_5NEG_net;
	wire [0:0] tmpIO_0__UVD_5NEG_net;
	wire [0:0] tmpINTERRUPT_0__UVD_5NEG_net;
	electrical [0:0] tmpSIOVREF__UVD_5NEG_net;

	cy_psoc3_pins_v1_10
		#(.id("73864147-89be-4832-9592-5f442f5a855d"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		UVD_5NEG
		 (.oe(tmpOE__UVD_5NEG_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__UVD_5NEG_net[0:0]}),
		  .analog({Net_501}),
		  .io({tmpIO_0__UVD_5NEG_net[0:0]}),
		  .siovref(tmpSIOVREF__UVD_5NEG_net),
		  .interrupt({tmpINTERRUPT_0__UVD_5NEG_net[0:0]}),
		  .annotation({Net_490}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__UVD_5NEG_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__UVD_5POS_net;
	wire [0:0] tmpFB_0__UVD_5POS_net;
	wire [0:0] tmpIO_0__UVD_5POS_net;
	wire [0:0] tmpINTERRUPT_0__UVD_5POS_net;
	electrical [0:0] tmpSIOVREF__UVD_5POS_net;

	cy_psoc3_pins_v1_10
		#(.id("397fe352-2fb2-4394-a97b-5596a8f1a009"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		UVD_5POS
		 (.oe(tmpOE__UVD_5POS_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__UVD_5POS_net[0:0]}),
		  .analog({Net_500}),
		  .io({tmpIO_0__UVD_5POS_net[0:0]}),
		  .siovref(tmpSIOVREF__UVD_5POS_net),
		  .interrupt({tmpINTERRUPT_0__UVD_5POS_net[0:0]}),
		  .annotation({Net_4164}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__UVD_5POS_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__UVD_5GAIN_net;
	wire [0:0] tmpFB_0__UVD_5GAIN_net;
	wire [0:0] tmpIO_0__UVD_5GAIN_net;
	wire [0:0] tmpINTERRUPT_0__UVD_5GAIN_net;
	electrical [0:0] tmpSIOVREF__UVD_5GAIN_net;

	cy_psoc3_pins_v1_10
		#(.id("f6561ae1-2639-40d7-9689-8e2766bae9be"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		UVD_5GAIN
		 (.oe(tmpOE__UVD_5GAIN_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__UVD_5GAIN_net[0:0]}),
		  .analog({Net_610}),
		  .io({tmpIO_0__UVD_5GAIN_net[0:0]}),
		  .siovref(tmpSIOVREF__UVD_5GAIN_net),
		  .interrupt({tmpINTERRUPT_0__UVD_5GAIN_net[0:0]}),
		  .annotation({Net_474}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__UVD_5GAIN_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("80c36a28-6f03-4e26-805b-6d06d58412f9"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("e282aeea-4068-4a30-a3ff-9f38376e4a29"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__V_BATTERY_net;
	wire [0:0] tmpFB_0__V_BATTERY_net;
	wire [0:0] tmpIO_0__V_BATTERY_net;
	wire [0:0] tmpINTERRUPT_0__V_BATTERY_net;
	electrical [0:0] tmpSIOVREF__V_BATTERY_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("77715107-f8d5-47e5-a629-0fb83101ac6b"),
		  ...
		  .input_buffer_sel(2'b00))
		V_BATTERY
		 (.oe(tmpOE__V_BATTERY_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__V_BATTERY_net[0:0]}),
		  .analog({Net_943}),
		  .io({tmpIO_0__V_BATTERY_net[0:0]}),
		  .siovref(tmpSIOVREF__V_BATTERY_net),
		  .interrupt({tmpINTERRUPT_0__V_BATTERY_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__V_BATTERY_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__GUVA_net;
	wire [0:0] tmpFB_0__GUVA_net;
	wire [0:0] tmpIO_0__GUVA_net;
	wire [0:0] tmpINTERRUPT_0__GUVA_net;
	electrical [0:0] tmpSIOVREF__GUVA_net;

	cy_psoc3_pins_v1_10
		#(.id("922d8f3c-c7b2-4fb8-9d53-54f4fc69ef17"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		GUVA
		 (.oe(tmpOE__GUVA_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__GUVA_net[0:0]}),
		  .analog({Net_1257}),
		  .io({tmpIO_0__GUVA_net[0:0]}),
		  .siovref(tmpSIOVREF__GUVA_net),
		  .interrupt({tmpINTERRUPT_0__GUVA_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__GUVA_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
