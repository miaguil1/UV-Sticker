...
{
    0x001Du,    /* Handle of the DIS service */
    {
        0x001Fu, /* Handle of the Manufacturer Name String characteristic */ 
        0x0021u, /* Handle of the Model Number String characteristic */ 
        0x0023u, /* Handle of the Serial Number String characteristic */ 
        0x0025u, /* Handle of the Hardware Revision String characteristic */ 
        0x0027u, /* Handle of the Firmware Revision String characteristic */ 
        0x0029u, /* Handle of the Software Revision String characteristic */ 
        0x002Bu, /* Handle of the System ID characteristic */ 
        0x002Du, /* Handle of the IEEE 11073-20601 Regulatory Certification Data List characteristic */ 
        0x002Fu, /* Handle of the PnP ID characteristic */ 
    },
};
