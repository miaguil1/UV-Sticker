...
{
    0x0015u,    /* Handle of the HTS service */
    {
        
        /* Temperature Measurement characteristic */
        {
            0x0017u, /* Handle of the Temperature Measurement characteristic */ 
        ...
        {
            0x001Au, /* Handle of the Temperature Type characteristic */ 
        ...
        {
            0x001Cu, /* Handle of the Intermediate Temperature characteristic */ 
        ...
        {
            0x001Fu, /* Handle of the Measurement Interval characteristic */ 
...
*  CYBLE_EVT_HTSC_NOTIFICATION event at the GATT Client's end.
*
...
*  which results in CYBLE_EVT_HTSC_INDICATION or 
