...
{
    #ifdef ISR_WDT_INTERRUPT_INTERRUPT_CALLBACK
        ISR_WDT_Interrupt_InterruptCallback();
    #endif /* ISR_WDT_INTERRUPT_INTERRUPT_CALLBACK */ 
...
*
*   Note calling ISR_WDT_Start or ISR_WDT_StartEx will 
*   override any effect this API would have had. This API should only be called
*   after ISR_WDT_Start or ISR_WDT_StartEx has been called. 
