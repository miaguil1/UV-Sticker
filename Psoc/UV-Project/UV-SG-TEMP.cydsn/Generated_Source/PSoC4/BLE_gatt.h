...
#define CYBLE_GATT_DB_INDEX_COUNT                    (0x0022u)
#define CYBLE_GATT_DB_ATT_VAL_COUNT                  (0x1Au)
#define CYBLE_GATT_DB_MAX_VALUE_LEN                  (0x0010u)

#endif /* CYBLE_GATT_ROLE_SERVER */

#define CYBLE_GATT_DB_CCCD_COUNT                     (0x4Au)
...
extern const uint8 cyBle_attUuid128[7u][16u];
